...
--maze_max_episode_steps=256 \
--test_n_episodes=10 \
--test_env_names=Maze-SixteenRooms,Maze-Labyrinth,Maze-StandardMaze \
--maze_test_see_agent=False \
--maze_test_normalize_obs=True \
--xpid=plr-maze13x13w0na_f-rpf_p0.8b4000t0.3s0.3m0.5r_mdef20bat_r1s_32p_1e_256t_ae1e-05_spvl-ppo_lr1e-05g0.999cv0.5ce0.0e5mb1l0.98_pc0.2_h32cf16fc1se5ba_re_lpo_ahg1_s5_h256nb2nl2_0
